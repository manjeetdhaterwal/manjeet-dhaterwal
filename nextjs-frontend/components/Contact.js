    ...
    <div className="container py-16 md:py-20" id="contact">
      ...
      <form className="mx-auto w-full pt-10 sm:w-3/4" onSubmit={handleSubmit}>
        <div className="flex flex-col md:flex-row">
          <input className="mr-3 w-full rounded border-blue-800 px-4 py-3 font-body text-black md:w-1/2 lg:mr-5"
            placeholder="Name" type="text" id="fullname" value={fullname} onChange={change} />
          <input
            className="mt-6 w-full rounded border-blue-800 px-4 py-3 font-body text-black md:mt-0 md:ml-3 md:w-1/2 lg:ml-5"
            placeholder="Email" type="text" id="email" value={email} onChange={change} />
        </div>
        <textarea className="mt-6 w-full rounded border-blue-800 px-4 py-3 font-body text-black md:mt-8"
